...
# 2020/01/28 - thx and credits to @airman604
# * script for locally building OWASP Limassol web page for testing and debugging
# * uses Jekyll Docker image, Docker and `jq` need to be installed
# * run in the www-chapter-limassol directory as it uses files in the current path
